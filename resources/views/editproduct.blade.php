        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/saveeditproduct') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('product_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="product_name" type="text" class="form-control" name="product_name" value="{{$productdata->name}}">
                        ...
                        <div class="form-group{{ $errors->has('product_sku') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="product_sku" type="text" class="form-control" name="product_sku" value="{{$productdata->sku}}">
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea rows="4", cols="54" class="form-control" id="description" name="description" style="resize:none, ">{{$productdata->description}}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('inventory') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="inventory" type="text" class="form-control" name="inventory" value="{{$productdata->inventory}}">
